  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.DialogContent
        {...props}
        className="fixed z-100 right-0 top-0 bottom-0 md:w-[400px]  border-l border-zinc-900 bg-zinc-950 p-4 overflow-y-auto w-full h-full "
      />
    </DialogPortal>
  );
}
...
export function DialogTitle(props: DialogPrimitive.DialogTitleProps) {
  return (
    <DialogPrimitive.DialogTitle
      {...props}
      className="font-roboto text-2xl font-normal text-mauve-dark-1100 tracking-normal"
    />
  );
}
